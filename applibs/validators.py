"""
All Global validators exists in this module.
Created at : 02-04-2019
Updated at : 02-04-2019
...
def is_sol_email_valid(email: str) -> bool:
    """
    Check SOLshare email is valid of not
    :return: True or False
    :rtype: bool
    """
    if email:
...
def name_validation(name: str, *args) -> bool:
    ...
    Example:
    In [19]: from applibs.validators import name_validation
...
def date_validation(date: str, *args) -> bool:
    ...
    In [13]: from applibs.validators import date_validation
